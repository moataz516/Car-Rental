...
namespace CarRental.Migrations
{
    ...
    [Migration("20230912133143_InitContactUs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarRental.Models.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("CarRental.Models.CustomerDetails", b =>
                {
            ...
            modelBuilder.Entity("CarRental.Models.Reservation", b =>
                {
                    ...
                    b.HasIndex("CusDetId")
                        .IsUnique()
                        .HasFilter("\"CusDetId\" IS NOT NULL");
            ...
            modelBuilder.Entity("CarRental.Models.UserDetails", b =>
                {
            ...
            modelBuilder.Entity("CarRental.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("CarRental.Models.CustomerDetails", "CusDet")
                        .WithOne("reservation")
                        .HasForeignKey("CarRental.Models.Reservation", "CusDetId");
            ...
            modelBuilder.Entity("CarRental.Models.UserDetails", b =>
                {
                    b.HasOne("CarRental.Models.ApplicationUser", "User")
                        .WithOne("UserDetails")
                        .HasForeignKey("CarRental.Models.UserDetails", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
